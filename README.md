...
2. **OpenClaw uses [ClawRouter](https://github.com/BlockRunAI/ClawRouter)** to access <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> LLMs
...
2. **BlockRun Gateway** — aggregates <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> LLMs + paid APIs (Exa, DALL-E, future Runway/Suno/CoinGecko) behind a single x402 endpoint.
